...
const AboutPage: React.FC = () => {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="min-h-[100vh] flex items-center pt-30 pb-16 px-20 py-20 bg-gradient-to-b from-[#8c52ff] to-white relative overflow-hidden">
        ...
        <div className="section-container relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-grayDark leading-relaxed mb-10 max-w-lg">
            ...
            <motion.div
              ...
              className="order-1 lg:order-3 relative"
            >
      ...
      <section className="px-20 py-16 bg-white relative">
        <div className="section-container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-8 md:p-10 rounded-3xl px-20 py-20 bg-grayLight/40 border border-gray-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group"
            >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-8 md:p-10 rounded-3xl bg-grayLight/40 border border-gray-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group"
            >
      ...
      <section className="px-20 py-12 border-y border-gray-200 bg-white">
        <div className="section-container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-gray-100">
            {[
              ...
              <div key={idx} className="flex flex-col items-center justify-center">
                ...
                <p className="text-sm font-medium text-grayDark uppercase tracking-wider">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Why Us Section */}
      <section className="section-padding px-20 py-20 bg-white">
        <div className="section-container">
      ...
      {/* Journey Section */}
      <section className="section-padding px-20 py-20 bg-grayLight">
        <div className="section-container">
          <div className="mb-16 text-center">
            <SectionHeading
              title="Our Journey"
              subtitle="The milestones that define our path to connecting the continent."
              className="px-20 py-20 text-black"
            />
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            {journey.map((item, index) => (
              <motion.div
                ...
                viewport={{ once: true, margin: "-50px" }}
                className="relative pl-10 pb-12 border-l-2 border-primary/30 last:pb-0 group"
              >
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 group-hover:shadow-md transition-shadow">
                  ...
                  <p className="text-grayDark leading-relaxed">{item.description}</p>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="section-padding bg-primary  relative overflow-hidden">
        ...
        <div className="section-container text-center px-20 py-20 relative z-10">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <h2 className="text-4xl md:text-5xl font-light text-[#8c53ff] mb-6 leading-tight">
              Ready to Shape the Future?
            </h2>
            <p className="text-white text-secondary/90 text-lg md:text-xl mb-10">
